...
entity pixel_pack_control_s_axi is
generic (
...
end entity pixel_pack_control_s_axi;
...
architecture behave of pixel_pack_control_s_axi is
    ...
    constant ADDR_ALPHA_DATA_0 : INTEGER := 16#18#;
    constant ADDR_ALPHA_CTRL   : INTEGER := 16#1c#;
