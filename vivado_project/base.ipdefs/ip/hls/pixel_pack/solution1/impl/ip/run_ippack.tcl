...
set Library     "hls"
set IPName      "pixel_pack"
set Version     "1.0"
set DisplayName "Pixel Pack"
set Revision    "2112791149"
set Description "Pixel Packing from 24-bit to 32-bit"
set Device      "zynq"
set AutoFamily  ""
...
set xo_kernel_name "pixel_pack"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/l17grati/workspace/projet3A/2022_2023/fewshot/PYNQ-2.7.0/boards/ip/hls/pixel_pack/solution1"
set debug_dir "/home/l17grati/workspace/projet3A/2022_2023/fewshot/PYNQ-2.7.0/boards/ip/hls/pixel_pack/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {pixel_pack_control_s_axi
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 mode W 0x0 "Data signal of mode" {{0 32 mode W 0 "Bit 31 to 0 of mode"}}} {0x18 alpha W 0x0 "Data signal of alpha" {{0 8 alpha W 0 "Bit 7 to 0 of alpha"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control stream_in_24 stream_out_32"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 7 machine 64 combinational 0 latency undef II x}
