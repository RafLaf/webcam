...
set Library     "hls"
set IPName      "pixel_unpack"
set Version     "1.0"
set DisplayName "Pixel Unpack"
set Revision    "2112791149"
set Description "Pixel Unpacking from 32-bit to 24-bit"
set Device      "zynq"
set AutoFamily  ""
...
set xo_kernel_name "pixel_unpack"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/l17grati/workspace/projet3A/2022_2023/fewshot/PYNQ-2.7.0/boards/ip/hls/pixel_unpack/solution1"
set debug_dir "/home/l17grati/workspace/projet3A/2022_2023/fewshot/PYNQ-2.7.0/boards/ip/hls/pixel_unpack/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {pixel_unpack_control_s_axi
...
## Variables
set Top "pixel_unpack"
set TopNoPrefix "pixel_unpack"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 mode W 0x0 "Data signal of mode" {{0 32 mode W 0 "Bit 31 to 0 of mode"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control stream_in_32 stream_out_24"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
