...
set Library     "hls"
set IPName      "color_convert"
set Version     "1.0"
set DisplayName "Color Convert"
set Revision    "2112791148"
set Description "Color conversion for 24-bit AXI video stream"
set Device      "zynq"
set AutoFamily  ""
...
set xo_kernel_name "color_convert"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/l17grati/workspace/projet3A/2022_2023/fewshot/PYNQ-2.7.0/boards/ip/hls/color_convert/solution1"
set debug_dir "/home/l17grati/workspace/projet3A/2022_2023/fewshot/PYNQ-2.7.0/boards/ip/hls/color_convert/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {color_convert_mul_10s_8ns_18_1_1
...
## Variables
set Top "color_convert"
set TopNoPrefix "color_convert"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 c1_0 W 0x0 "Data signal of c1_0" {{0 10 c1_0 W 0 "Bit 9 to 0 of c1_0"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 c1_1 W 0x0 "Data signal of c1_1" {{0 10 c1_1 W 0 "Bit 9 to 0 of c1_1"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 c1_2 W 0x0 "Data signal of c1_2" {{0 10 c1_2 W 0 "Bit 9 to 0 of c1_2"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 c2_0 W 0x0 "Data signal of c2_0" {{0 10 c2_0 W 0 "Bit 9 to 0 of c2_0"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 c2_1 W 0x0 "Data signal of c2_1" {{0 10 c2_1 W 0 "Bit 9 to 0 of c2_1"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 c2_2 W 0x0 "Data signal of c2_2" {{0 10 c2_2 W 0 "Bit 9 to 0 of c2_2"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 c3_0 W 0x0 "Data signal of c3_0" {{0 10 c3_0 W 0 "Bit 9 to 0 of c3_0"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 c3_1 W 0x0 "Data signal of c3_1" {{0 10 c3_1 W 0 "Bit 9 to 0 of c3_1"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 c3_2 W 0x0 "Data signal of c3_2" {{0 10 c3_2 W 0 "Bit 9 to 0 of c3_2"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 bias_0 W 0x0 "Data signal of bias_0" {{0 10 bias_0 W 0 "Bit 9 to 0 of bias_0"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 bias_1 W 0x0 "Data signal of bias_1" {{0 10 bias_1 W 0 "Bit 9 to 0 of bias_1"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 bias_2 W 0x0 "Data signal of bias_2" {{0 10 bias_2 W 0 "Bit 9 to 0 of bias_2"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control stream_in_24 stream_out_24"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 7 machine 64 combinational 0 latency 5 II 1}
