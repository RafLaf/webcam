...
def parse_args_demonstration(parser):
    ...
    demonstration_arguments.add_argument("--output-resolution",default=[800,480],nargs="+",type=int,help="output resolution of the opencv frame (width height) (for the pynq)")
    demonstration_arguments.add_argument("--padding",default=[0,0],nargs="+",type=int,help="padding for the output (for the pynq)")
